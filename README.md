...
```
npm install --save-dev browser-sync gulp-sass gulp-sourcemaps gulp-autoprefixer gulp-clean-css gulp-uglify gulp-concat gulp-imagemin gulp-changed gulp-html-replace gulp-htmlmin del run-sequence
```
